...
#' @param d_por Vector of numberic values for deaths in each place of residence.
...
#' @param b_por Vector of numberic values for births in each place of residence. For use when \code{method = "accounting"}.
#'
#' @return
